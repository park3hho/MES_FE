    ...
    try {
      ...
      if (
        ...
        if (!form.problem_process) {
          ...
          try {
            // 검사 화면 재작업 = QC 경로 (2026-09-11) — /lot/repair(admin.manage) 대신 send-repair (IPQInspectPage 와 동일).
            //   권한 = qc.iq, 범위 = 이 검사 행의 LOT. 재공정 LOT 연결(lot_no/repair_lot_no/비고)은 BE 가 처리.
