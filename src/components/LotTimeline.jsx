  ...
  return (
    <div className={s.branchMini}>
      <div className={s.branchHeader} onClick={() => setExpanded(!expanded)}>
        {/* 화살표 — 회전값은 동적 */}
        <span className={s.arrow} style={{ transform: expanded ? 'rotate(90deg)' : 'rotate(0)' }}>▶</span>
        <span className={s.branchTitle}>{itemLabel} {branchIdx + 1}</span>
                  ...
                  <div className={s.subItem}>
                    ...
                    <div className={s.subBody}>
                      <div className={s.subHead}>
                        ...
                        <span className={s.subStatus} style={{ color: statusColor }}>{statusLabel}</span>
                      </div>
            ...
            >
              ...
              <div className={s.itemBody}>
                <div className={s.itemHead}>
                  ...
                  <span className={s.itemStatus} style={{ color: statusColor }}>{statusLabel}</span>
                </div>
                ...
                {hasBranches && (
                  <div className={s.branchToggle} onClick={() => toggleBranch(branchKey)}>
                    <span className={s.arrow} style={{ transform: branchOpen ? 'rotate(90deg)' : 'rotate(0)' }}>▶</span>
                    {item.branch_count}개 {getBranchLabel(item.process)} 투입
                  </div>
                )}
              </div>
